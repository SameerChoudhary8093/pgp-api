...
exports.CommitteesModule = CommitteesModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [committees_controller_1.CommitteesController],
        providers: [committees_service_1.CommitteesService, prisma_service_1.PrismaService, audit_service_1.AuditService],
        exports: [committees_service_1.CommitteesService],
    })
], CommitteesModule);
